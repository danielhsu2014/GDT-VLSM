...
[![Demo](https://img.shields.io/badge/Gradio-Demo-orange)]([https://baker-organizations-bool-sheffield.trycloudflare.com/](https://dangerous-thanksgiving-combination-court.trycloudflare.com/))
...
## Model and Dataset Usage Notice

The models, model weights, checkpoints, datasets, and any generated
outputs associated with this project are released for academic research
and educational purposes only.

Commercial use, including but not limited to use in for-profit products,
services, internal industrial deployment, data redistribution for
commercial purposes, or technology transfer, is strictly prohibited
